...
add_action( 'wp_enqueue_scripts', 'utiljs' );
function utiljs(){
  wp_enqueue_script( 'utiljs', get_stylesheet_directory_uri() . './assets/js/util.js', array( 'jquery' ) );
}

add_action( 'wp_enqueue_scripts', 'codyjs' );
function codyjs(){
  wp_enqueue_script( 'codyjs', get_stylesheet_directory_uri() . './assets/js/scripts.js', array( 'jquery' ) );
}