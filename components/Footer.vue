<template>
    <footer class="footer-v4 py-8 lg:py-12">
        <div class="w-[calc(100%_-_2.5rem)] lg:w-[calc(100%_-_4rem)] mx-auto max-w-7xl">
            ...
            <a target="_blank" href="#0">
                <load-svg name="facebook" class="w-7 text-contrast-high hover:text-contrast-higher" />
            </a>

            <a target="_blank" href="#0">
                <load-svg name="instagram" class="w-7 text-contrast-high hover:text-contrast-higher" />
            </a>
            </div>
        </div>
</footer>
